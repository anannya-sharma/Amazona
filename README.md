...
8. Build Product Screen
   ...
   6. Add a new Route from product details to App.js
...
9. Create Node.JS Server
   ...
   11. return products
   12. run npm start
10. Load Products From the Backend
